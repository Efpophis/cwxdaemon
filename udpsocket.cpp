...
const unsigned short UdpSocket::port() const
{
...
int UdpSocket::receive(unsigned char* msg, uint32_t length, unsigned short* port)
{
    int result = -1;
...
int UdpSocket::send(const std::string& host, unsigned short port, 
